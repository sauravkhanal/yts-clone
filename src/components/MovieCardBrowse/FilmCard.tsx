    ...
    return (
        <>
            <div>
                ...
                {/* image */}
                <div className="border-[5px] border-white rounded-sm w-[180px] h-[265px] 
                ...
                {/* text */}
                <div>
                    <p className="text-white font-bold hover:text-text2 max-w-[170px] line-clamp-1 overflow-clip"><a href="">{title ?? "Title"}</a></p>
