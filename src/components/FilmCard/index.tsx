    ...
    return (
        <>
            <div>
                ...
                {/* image */}
                <div className="border-[5px] border-border1 rounded-sm w-[212.5px] h-[325px] 
                ...
                {/* text */}
                <div>
                    <p className="text-text1 font-bold hover:text-text2 max-w-[210px] line-clamp-1 overflow-clip"><a href="">{title ?? "Title"}</a></p>
