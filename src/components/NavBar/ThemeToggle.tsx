...
export default function ThemeToggle() {
    ...
    return (
        <button className={` overflow-hidden group rounded-md bg-${isDarkTheme ? "white" : "black"}  transition-all duration-300 opacity-80 hover:opacity-100 h-6 w-6 md:h-8 md:w-12 lg:w-14`} onClick={handleClick}>
            {icon}
        </button>
    );
}
